  ...
  return (
    <main className="min-h-screen">
      <SEO
        ...
        description="Consulte CPF direto no WhatsApp. Descubra nome, idade e situação cadastral. Rápido, seguro e 100% online."
        path="/cpf"
        ogDescription="Descubra nome, idade e situação cadastral de qualquer CPF. Tudo direto no WhatsApp."
      />
      <Header />
      <HeroSection />
      <HowItWorks />
